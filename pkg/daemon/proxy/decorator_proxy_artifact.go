...
// DecoratorProxyArtifactStatus is a status for decorator
...
// DecoratorProxyArtifact is a decorator for daemon task runners
func DecoratorProxyArtifact(runner func(context.Context, *models.Artifact, chan DecoratorArtifactStatus) error) func(context.Context, *asynq.Task) error {
