...
func (c *clients) GetManifest(ctx context.Context, repository, reference string) (distribution.Manifest, distribution.Descriptor, error) {
	...
	header.Add(consts.HeaderAccept, "application/vnd.docker.distribution.manifest.list.v2+json")
	header.Add(consts.HeaderAccept, "application/vnd.oci.image.index.v1+json")
	header.Add(consts.HeaderAccept, "application/vnd.oci.image.manifest.v1+json")
