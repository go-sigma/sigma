...
// Source: github.com/go-sigma/sigma/pkg/distribution/clients (interfaces: ClientsFactory)
//
// Generated by this command:
//
//	mockgen -destination=mocks/clients_factory.go -package=mocks github.com/go-sigma/sigma/pkg/distribution/clients ClientsFactory
//
...
import (
	...
	clients "github.com/go-sigma/sigma/pkg/distribution/clients"
...
func (m *MockClientsFactory) New(config *config.Configuration) (clients.Clients, error) {
	m.ctrl.T.Helper()
