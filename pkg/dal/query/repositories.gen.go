...
func newRepository(db *gorm.DB, opts ...gen.DOOption) repository {
	...
	_repository.ID = field.NewString(tableName, "id")
	_repository.NamespaceID = field.NewString(tableName, "namespace_id")
	...
	_repository.SizeDirty = field.NewBool(tableName, "size_dirty")
...
func (r *repository) updateTableName(table string) *repository {
	...
	r.NamespaceID = field.NewString(table, "namespace_id")
	...
	r.SizeDirty = field.NewBool(table, "size_dirty")
...
func (r *repository) fillFieldMap() {
	...
	r.fieldMap["size_dirty"] = r.SizeDirty
