...
func newAudit(db *gorm.DB, opts ...gen.DOOption) audit {
	...
	_audit.UserID = field.NewString(tableName, "user_id")
	_audit.Username = field.NewString(tableName, "username")
	_audit.UserRole = field.NewString(tableName, "user_role")
	_audit.NamespaceID = field.NewString(tableName, "namespace_id")
	_audit.Method = field.NewString(tableName, "method")
	_audit.Path = field.NewString(tableName, "path")
	_audit.Route = field.NewString(tableName, "route")
	...
	_audit.UserAgent = field.NewString(tableName, "user_agent")
	_audit.LatencyMs = field.NewInt64(tableName, "latency_ms")
...
func (a *audit) updateTableName(table string) *audit {
	...
	a.UserRole = field.NewString(table, "user_role")
	...
	a.StatusCode = field.NewInt(table, "status_code")
	a.ClientIP = field.NewString(table, "client_ip")
	a.UserAgent = field.NewString(table, "user_agent")
	a.LatencyMs = field.NewInt64(table, "latency_ms")
...
func (a *audit) fillFieldMap() {
	...
	a.fieldMap["user_role"] = a.UserRole
