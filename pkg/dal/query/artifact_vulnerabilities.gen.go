...
func newArtifactVulnerability(db *gorm.DB, opts ...gen.DOOption) artifactVulnerability {
	...
	_artifactVulnerability.ID = field.NewString(tableName, "id")
	_artifactVulnerability.ArtifactID = field.NewString(tableName, "artifact_id")
	_artifactVulnerability.Version = field.NewInt64(tableName, "version")
