...
func newDaemonGcTagRunner(db *gorm.DB, opts ...gen.DOOption) daemonGcTagRunner {
	...
	_daemonGcTagRunner.CreatedAt = field.NewInt64(tableName, "created_at")
	_daemonGcTagRunner.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_daemonGcTagRunner.DeletedAt = field.NewUint(tableName, "deleted_at")
	_daemonGcTagRunner.ID = field.NewString(tableName, "id")
	_daemonGcTagRunner.RuleID = field.NewString(tableName, "rule_id")
	...
	_daemonGcTagRunner.OperateUserID = field.NewString(tableName, "operate_user_id")
