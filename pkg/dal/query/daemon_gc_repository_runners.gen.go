...
func newDaemonGcRepositoryRunner(db *gorm.DB, opts ...gen.DOOption) daemonGcRepositoryRunner {
	...
	_daemonGcRepositoryRunner.ID = field.NewString(tableName, "id")
	_daemonGcRepositoryRunner.RuleID = field.NewString(tableName, "rule_id")
	...
	_daemonGcRepositoryRunner.OperateUserID = field.NewString(tableName, "operate_user_id")
