...
func newBuilder(db *gorm.DB, opts ...gen.DOOption) builder {
	...
	_builder.ID = field.NewString(tableName, "id")
	_builder.RepositoryID = field.NewString(tableName, "repository_id")
	_builder.Source = field.NewField(tableName, "source")
	_builder.CodeRepositoryID = field.NewString(tableName, "code_repository_id")
	...
	_builder.CronNextTrigger = field.NewInt64(tableName, "cron_next_trigger")
	...
	_builder.CodeRepository = builderBelongsToCodeRepository{
		...
		User3rdParty: struct {
			...
			RelationField: field.NewRelation("CodeRepository.User3rdParty", "models.User3rdParty"),
			User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CodeRepository.User3rdParty.User", "models.User"),
			},
		},
		Branches: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("CodeRepository.Branches", "models.CodeRepositoryBranch"),
		},
	}
...
func (b *builder) updateTableName(table string) *builder {
	...
	b.RepositoryID = field.NewString(table, "repository_id")
	b.Source = field.NewField(table, "source")
	b.CodeRepositoryID = field.NewString(table, "code_repository_id")
	...
	b.CronNextTrigger = field.NewInt64(table, "cron_next_trigger")
