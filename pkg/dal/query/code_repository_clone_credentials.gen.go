...
func newCodeRepositoryCloneCredential(db *gorm.DB, opts ...gen.DOOption) codeRepositoryCloneCredential {
	...
	_codeRepositoryCloneCredential.CreatedAt = field.NewInt64(tableName, "created_at")
	_codeRepositoryCloneCredential.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_codeRepositoryCloneCredential.DeletedAt = field.NewUint(tableName, "deleted_at")
	_codeRepositoryCloneCredential.ID = field.NewString(tableName, "id")
	_codeRepositoryCloneCredential.User3rdPartyID = field.NewString(tableName, "user_3rdparty_id")
...
func (c *codeRepositoryCloneCredential) updateTableName(table string) *codeRepositoryCloneCredential {
	...
	c.User3rdPartyID = field.NewString(table, "user_3rdparty_id")
