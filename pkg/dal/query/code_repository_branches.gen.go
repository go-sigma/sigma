...
func newCodeRepositoryBranch(db *gorm.DB, opts ...gen.DOOption) codeRepositoryBranch {
	...
	_codeRepositoryBranch.CreatedAt = field.NewInt64(tableName, "created_at")
	_codeRepositoryBranch.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_codeRepositoryBranch.DeletedAt = field.NewUint(tableName, "deleted_at")
	_codeRepositoryBranch.ID = field.NewString(tableName, "id")
	_codeRepositoryBranch.CodeRepositoryID = field.NewString(tableName, "code_repository_id")
...
func (c *codeRepositoryBranch) updateTableName(table string) *codeRepositoryBranch {
	...
	c.CodeRepositoryID = field.NewString(table, "code_repository_id")
