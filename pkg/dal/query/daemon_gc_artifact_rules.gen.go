...
func newDaemonGcArtifactRule(db *gorm.DB, opts ...gen.DOOption) daemonGcArtifactRule {
	...
	_daemonGcArtifactRule.ID = field.NewString(tableName, "id")
	_daemonGcArtifactRule.NamespaceID = field.NewString(tableName, "namespace_id")
	...
	_daemonGcArtifactRule.CronNextTrigger = field.NewInt64(tableName, "cron_next_trigger")
