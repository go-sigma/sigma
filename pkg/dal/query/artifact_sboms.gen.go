...
func newArtifactSbom(db *gorm.DB, opts ...gen.DOOption) artifactSbom {
	...
	_artifactSbom.CreatedAt = field.NewInt64(tableName, "created_at")
	_artifactSbom.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_artifactSbom.DeletedAt = field.NewUint(tableName, "deleted_at")
	_artifactSbom.ID = field.NewString(tableName, "id")
	_artifactSbom.ArtifactID = field.NewString(tableName, "artifact_id")
		...
		Tags: struct {
			...
			Repository: struct {
				...
				Namespace: struct {
					...
					RelationField: field.NewRelation("Artifact.Tags.Repository.Namespace", "models.Namespace"),
				},
				Builder: struct {
					field.RelationField
					Repository struct {
					...
					RelationField: field.NewRelation("Artifact.Tags.Repository.Builder", "models.Builder"),
					Repository: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("Artifact.Tags.Repository.Builder.Repository", "models.Repository"),
					},
					CodeRepository: struct {
						field.RelationField
						User3rdParty struct {
						...
						RelationField: field.NewRelation("Artifact.Tags.Repository.Builder.CodeRepository", "models.CodeRepository"),
						User3rdParty: struct {
							field.RelationField
							User struct {
								field.RelationField
							...
							RelationField: field.NewRelation("Artifact.Tags.Repository.Builder.CodeRepository.User3rdParty", "models.User3rdParty"),
							User: struct {
								field.RelationField
							}{
								RelationField: field.NewRelation("Artifact.Tags.Repository.Builder.CodeRepository.User3rdParty.User", "models.User"),
							},
						},
						Branches: struct {
							field.RelationField
						}{
							RelationField: field.NewRelation("Artifact.Tags.Repository.Builder.CodeRepository.Branches", "models.CodeRepositoryBranch"),
						},
					},
				},
			},
...
func (a *artifactSbom) updateTableName(table string) *artifactSbom {
	...
	a.ArtifactID = field.NewString(table, "artifact_id")
...
func (a artifactSbom) Columns(cols ...field.Expr) gen.Columns {
	return a.artifactSbomDo.Columns(cols...)
}
