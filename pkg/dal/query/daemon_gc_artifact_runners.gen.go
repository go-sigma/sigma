...
func newDaemonGcArtifactRunner(db *gorm.DB, opts ...gen.DOOption) daemonGcArtifactRunner {
	...
	_daemonGcArtifactRunner.ID = field.NewString(tableName, "id")
	_daemonGcArtifactRunner.RuleID = field.NewString(tableName, "rule_id")
	...
	_daemonGcArtifactRunner.OperateUserID = field.NewString(tableName, "operate_user_id")
