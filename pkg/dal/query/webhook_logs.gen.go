...
func newWebhookLog(db *gorm.DB, opts ...gen.DOOption) webhookLog {
	...
	_webhookLog.ID = field.NewString(tableName, "id")
	_webhookLog.WebhookID = field.NewString(tableName, "webhook_id")
	...
	_webhookLog.TraceContext = field.NewBytes(tableName, "trace_context")
...
type webhookLog struct {
	...
	ID           field.String
	WebhookID    field.String
	ResourceType field.Field
	Action       field.Field
	StatusCode   field.Int
	TraceContext field.Bytes
...
func (w *webhookLog) updateTableName(table string) *webhookLog {
	...
	w.WebhookID = field.NewString(table, "webhook_id")
	...
	w.TraceContext = field.NewBytes(table, "trace_context")
...
func (w *webhookLog) fillFieldMap() {
	...
	w.fieldMap["trace_context"] = w.TraceContext
