...
func newNamespaceMember(db *gorm.DB, opts ...gen.DOOption) namespaceMember {
	...
	_namespaceMember.ID = field.NewString(tableName, "id")
	_namespaceMember.UserID = field.NewString(tableName, "user_id")
	_namespaceMember.NamespaceID = field.NewString(tableName, "namespace_id")
