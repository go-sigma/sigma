...
func newBlobUpload(db *gorm.DB, opts ...gen.DOOption) blobUpload {
	...
	_blobUpload.ID = field.NewString(tableName, "id")
	_blobUpload.PartNumber = field.NewInt32(tableName, "part_number")
...
func (b *blobUpload) updateTableName(table string) *blobUpload {
	...
	b.PartNumber = field.NewInt32(table, "part_number")
