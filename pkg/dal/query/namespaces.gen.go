...
func newNamespace(db *gorm.DB, opts ...gen.DOOption) namespace {
	...
	_namespace.ID = field.NewString(tableName, "id")
	...
	_namespace.SizeDirty = field.NewBool(tableName, "size_dirty")
...
func (n *namespace) updateTableName(table string) *namespace {
	...
	n.SizeDirty = field.NewBool(table, "size_dirty")
...
func (n *namespace) fillFieldMap() {
	...
	n.fieldMap["size_dirty"] = n.SizeDirty
}
