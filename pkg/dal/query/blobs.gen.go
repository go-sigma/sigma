...
func newBlob(db *gorm.DB, opts ...gen.DOOption) blob {
	...
	_blob.ID = field.NewString(tableName, "id")
	...
	_blob.Artifacts = blobManyToManyArtifacts{
		...
		Namespace: struct {
			...
			RelationField: field.NewRelation("Artifacts.Namespace", "models.Namespace"),
		},
		Repository: struct {
			field.RelationField
			Namespace struct {
		...
		Tags: struct {
			...
			Repository: struct {
				...
				Namespace: struct {
					...
					RelationField: field.NewRelation("Artifacts.Tags.Repository.Namespace", "models.Namespace"),
				},
				Builder: struct {
					field.RelationField
					Repository struct {
					...
					RelationField: field.NewRelation("Artifacts.Tags.Repository.Builder", "models.Builder"),
					Repository: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("Artifacts.Tags.Repository.Builder.Repository", "models.Repository"),
					},
					CodeRepository: struct {
						field.RelationField
						User3rdParty struct {
						...
						RelationField: field.NewRelation("Artifacts.Tags.Repository.Builder.CodeRepository", "models.CodeRepository"),
						User3rdParty: struct {
							field.RelationField
							User struct {
								field.RelationField
							...
							RelationField: field.NewRelation("Artifacts.Tags.Repository.Builder.CodeRepository.User3rdParty", "models.User3rdParty"),
							User: struct {
								field.RelationField
							}{
								RelationField: field.NewRelation("Artifacts.Tags.Repository.Builder.CodeRepository.User3rdParty.User", "models.User"),
							},
						},
						Branches: struct {
							field.RelationField
						}{
							RelationField: field.NewRelation("Artifacts.Tags.Repository.Builder.CodeRepository.Branches", "models.CodeRepositoryBranch"),
						},
					},
				},
			},
...
func (b blobDo) BlobAssociateWithArtifact(ids []string) (result map[string]interface{}, err error) {
