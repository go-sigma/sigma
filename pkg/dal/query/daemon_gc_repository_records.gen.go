...
func newDaemonGcRepositoryRecord(db *gorm.DB, opts ...gen.DOOption) daemonGcRepositoryRecord {
	...
	_daemonGcRepositoryRecord.CreatedAt = field.NewInt64(tableName, "created_at")
	_daemonGcRepositoryRecord.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_daemonGcRepositoryRecord.DeletedAt = field.NewUint(tableName, "deleted_at")
	_daemonGcRepositoryRecord.ID = field.NewString(tableName, "id")
	_daemonGcRepositoryRecord.RunnerID = field.NewString(tableName, "runner_id")
...
func (a daemonGcRepositoryRecordBelongsToRunner) Unscoped() *daemonGcRepositoryRecordBelongsToRunner {
	a.db = a.db.Unscoped()
	return &a
}
...
func (a daemonGcRepositoryRecordBelongsToRunnerTx) Unscoped() *daemonGcRepositoryRecordBelongsToRunnerTx {
	a.tx = a.tx.Unscoped()
	return &a
}
