...
func newDaemonGcBlobRunner(db *gorm.DB, opts ...gen.DOOption) daemonGcBlobRunner {
	...
	_daemonGcBlobRunner.ID = field.NewString(tableName, "id")
	_daemonGcBlobRunner.RuleID = field.NewString(tableName, "rule_id")
	...
	_daemonGcBlobRunner.OperateUserID = field.NewString(tableName, "operate_user_id")
