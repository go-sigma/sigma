...
func newDaemonGcBlobRule(db *gorm.DB, opts ...gen.DOOption) daemonGcBlobRule {
	...
	_daemonGcBlobRule.CreatedAt = field.NewInt64(tableName, "created_at")
	_daemonGcBlobRule.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_daemonGcBlobRule.DeletedAt = field.NewUint(tableName, "deleted_at")
	_daemonGcBlobRule.ID = field.NewString(tableName, "id")
