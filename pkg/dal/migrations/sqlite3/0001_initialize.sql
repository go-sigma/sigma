...
CREATE TABLE IF NOT EXISTS `user_3rdparty` (
  ...
  `cr_last_update_timestamp` integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS `code_repository_clone_credentials` (
  ...
  `type` varchar(64) NOT NULL DEFAULT 'none',
  `ssh_key` BLOB,
...
CREATE TABLE IF NOT EXISTS `namespaces` (
  ...
  `size_dirty` integer NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `gc_storage_deletion_tasks` (
  ...
  `updated_at` integer NOT NULL,
  `deleted_at` integer NOT NULL DEFAULT 0,
  CONSTRAINT `gc_storage_deletion_tasks_unique_resource` UNIQUE (
    `resource_type`,
    `resource_id`,
    `storage_path_hash`,
    `deleted_at`
...
CREATE TABLE IF NOT EXISTS `namespace_members` (
  ...
  `user_id` varchar(36) NOT NULL,
  `namespace_id` varchar(36) NOT NULL,
  `role` varchar(64) NOT NULL DEFAULT 'namespace_reader',
  `created_at` integer NOT NULL,
  `updated_at` integer NOT NULL,
  `deleted_at` integer NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `namespace_activity_hourlies` (
  ...
  `tag_delta` integer NOT NULL DEFAULT 0,
  `created_at` integer NOT NULL,
  `updated_at` integer NOT NULL,
