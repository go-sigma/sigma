...
CREATE TABLE IF NOT EXISTS "namespaces" (
  ...
  "size_dirty" boolean NOT NULL DEFAULT FALSE,
...
CREATE INDEX "artifacts_idx_gc_deletable" ON "artifacts" (
  "repository_id",
  "deleted_at",
  "last_pull",
  "updated_at",
...
CREATE TABLE IF NOT EXISTS "artifact_artifacts" (
  ...
  PRIMARY KEY ("artifact_id", "artifact_sub_id")
);
...
CREATE INDEX "gc_storage_deletion_tasks_idx_status" ON "gc_storage_deletion_tasks" ("status", "deleted_at", "updated_at");
...
CREATE TABLE IF NOT EXISTS "webhooks" (
  ...
  "event_repository" boolean NOT NULL DEFAULT TRUE,
  "event_tag" boolean NOT NULL DEFAULT TRUE,
  "event_artifact" boolean NOT NULL DEFAULT TRUE,
  "event_member" boolean NOT NULL DEFAULT TRUE,
  "event_daemon_task_gc" boolean NOT NULL DEFAULT TRUE,
  "created_at" bigint NOT NULL,
  "updated_at" bigint NOT NULL,
  "deleted_at" bigint NOT NULL DEFAULT 0
);
...
CREATE INDEX "user_activity_hourlies_idx_user_hour" ON "user_activity_hourlies" ("user_id", "hour");
...
CREATE INDEX "namespace_activity_hourlies_idx_namespace_hour" ON "namespace_activity_hourlies" ("namespace_id", "hour");
