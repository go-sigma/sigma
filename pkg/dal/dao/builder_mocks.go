...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: BuilderService,BuilderServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=builder_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao BuilderService,BuilderServiceFactory
//
...
func (m *MockBuilderServiceFactory) New(txs ...*query.Query) BuilderService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
