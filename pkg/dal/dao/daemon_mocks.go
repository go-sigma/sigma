...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: DaemonService,DaemonServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=daemon_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao DaemonService,DaemonServiceFactory
//
...
func (m *MockDaemonServiceFactory) New(txs ...*query.Query) DaemonService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
