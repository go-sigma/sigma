...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: ArtifactService,ArtifactServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=artifact_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao ArtifactService,ArtifactServiceFactory
//
...
func (m *MockArtifactServiceFactory) New(txs ...*query.Query) ArtifactService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
