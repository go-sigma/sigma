...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: RepositoryService,RepositoryServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=repository_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao RepositoryService,RepositoryServiceFactory
//
...
func (m *MockRepositoryService) Create(ctx context.Context, repositoryObj *models.Repository, autoCreateNamespace AutoCreateNamespace) error {
	m.ctrl.T.Helper()
...
func (m *MockRepositoryServiceFactory) New(txs ...*query.Query) RepositoryService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(RepositoryService)
	return ret0
}
