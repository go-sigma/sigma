...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: BlobService,BlobServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=blob_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao BlobService,BlobServiceFactory
//
...
func (m *MockBlobServiceFactory) New(txs ...*query.Query) BlobService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
