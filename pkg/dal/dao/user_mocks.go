...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: UserService,UserServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=user_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao UserService,UserServiceFactory
//
...
func (m *MockUserServiceFactory) New(txs ...*query.Query) UserService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
