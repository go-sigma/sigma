...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: CodeRepositoryService,CodeRepositoryServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=code_repository_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao CodeRepositoryService,CodeRepositoryServiceFactory
//
...
func (m *MockCodeRepositoryServiceFactory) New(txs ...*query.Query) CodeRepositoryService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
	...
	ret0, _ := ret[0].(CodeRepositoryService)
	return ret0
}
