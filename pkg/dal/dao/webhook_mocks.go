...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: WebhookService,WebhookServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=webhook_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao WebhookService,WebhookServiceFactory
//
...
func (m *MockWebhookServiceFactory) New(txs ...*query.Query) WebhookService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
