...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: BlobUploadService,BlobUploadServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=blobupload_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao BlobUploadService,BlobUploadServiceFactory
//
...
func (m *MockBlobUploadServiceFactory) New(txs ...*query.Query) BlobUploadService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
	...
	ret0, _ := ret[0].(BlobUploadService)
	return ret0
}
