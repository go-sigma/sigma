...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: NamespaceMemberService,NamespaceMemberServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=namespace_member_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao NamespaceMemberService,NamespaceMemberServiceFactory
//
...
func (m *MockNamespaceMemberServiceFactory) New(txs ...*query.Query) NamespaceMemberService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
	...
	ret0, _ := ret[0].(NamespaceMemberService)
	return ret0
}
