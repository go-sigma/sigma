...
// Source: github.com/go-sigma/sigma/pkg/dal/dao (interfaces: TagService,TagServiceFactory)
//
// Generated by this command:
//
//	mockgen -destination=tag_mocks.go -package=dao github.com/go-sigma/sigma/pkg/dal/dao TagService,TagServiceFactory
//
...
func (m *MockTagService) Create(ctx context.Context, tag *models.Tag, options ...Option) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, tag}
...
func (m *MockTagServiceFactory) New(txs ...*query.Query) TagService {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range txs {
		varargs = append(varargs, a)
