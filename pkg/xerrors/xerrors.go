...
// Error is a generic error type that can be used to wrap other errors.
type Error struct {
	// Code is a machine-readable error code. This field is optional.
	Code string `json:"code,omitempty"`
	// Message is a human-readable error message. This field is required.
	Message string `json:"message"`
	// Details is a human-readable error message. This field is optional.
	Details string `json:"details,omitempty"`
	// Err is the error that caused this error. This field is optional.
