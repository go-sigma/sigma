...
func TestFactory(t *testing.T) {
	...
	require.NoError(t, digCon.Invoke(func(engine *gin.Engine) {
		...
		require.True(t, hasRoute(routes, http.MethodPost, "/api/v1/webhooks/"))
		require.True(t, hasRoute(routes, http.MethodGet, "/api/v1/webhooks/:webhook_id/logs/"))
		require.True(t, hasRoute(routes, http.MethodDelete, "/api/v1/webhooks/:webhook_id/logs/:webhook_log_id"))
		require.True(t, hasRoute(routes, http.MethodGet, "/api/v1/webhooks/:webhook_id/logs/:webhook_log_id/resend"))
	}))
}
