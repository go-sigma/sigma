...
func TestDeleteNamespace(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodDelete, consts.APIV1+"/namespaces/1", nil)
...
func TestDeleteNamespaceReturnsUnauthorizedWhenAuthFails(t *testing.T) {
	require.NoError(t, validators.Initialize())
...
func TestDeleteNamespaceReturnsServiceError(t *testing.T) {
	require.NoError(t, validators.Initialize())
