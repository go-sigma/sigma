...
func (h *handler) UpdateGcArtifactRule(c *gin.Context, req *api.UpdateGcArtifactRuleRequest) {
	ctx := c.Request.Context()

	err := h.DaemonSvc.UpdateGcArtifactRule(ctx, *req)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("Update gc artifact rule failed: %v", err))
		return
	}
...
//	@Failure	404				{object}	errcode.ErrCode
//	@Failure	500				{object}	errcode.ErrCode
func (h *handler) GetGcArtifactRule(c *gin.Context, req *api.GetGcArtifactRuleRequest) {
	ctx := c.Request.Context()

	ruleObj, err := h.DaemonSvc.GetGcArtifactRule(ctx, req.NamespaceID)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("Get gc artifact rule failed: %v", err))
		return
	}
	...
	c.JSON(http.StatusOK, api.GetGcArtifactRuleResponse{
...
//	@Failure	404				{object}	errcode.ErrCode
//	@Failure	500				{object}	errcode.ErrCode
func (h *handler) GetGcArtifactLatestRunner(c *gin.Context, req *api.GetGcArtifactLatestRunnerRequest) {
	ctx := c.Request.Context()

	runnerObj, err := h.DaemonSvc.GetGcArtifactLatestRunner(ctx, req.NamespaceID)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("Get gc artifact latest runner failed: %v", err))
		return
	}
	...
	c.JSON(http.StatusOK, api.GcArtifactRunnerItem{
		ID:           runnerObj.ID,
...
//	@Failure	404	{object}	errcode.ErrCode
//	@Failure	500	{object}	errcode.ErrCode
func (h *handler) CreateGcArtifactRunner(c *gin.Context, req *api.CreateGcArtifactRunnerRequest) {
	ctx := c.Request.Context()

	err := h.DaemonSvc.CreateGcArtifactRunner(ctx, *req)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("Create gc artifact runner failed: %v", err))
		return
	}
...
//	@Success	200				{object}	api.CommonList{items=[]api.GcArtifactRunnerItem}
//	@Failure	400				{object}	errcode.ErrCode
//	@Failure	404				{object}	errcode.ErrCode
//	@Failure	500				{object}	errcode.ErrCode
func (h *handler) ListGcArtifactRunners(c *gin.Context, req *api.ListGcArtifactRunnersRequest) {
	ctx := c.Request.Context()

	runnerObjs, total, err := h.DaemonSvc.ListGcArtifactRunners(ctx, req.NamespaceID, req.Pagination, req.Sortable)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("List gc artifact runners failed: %v", err))
		return
	}
	...
	for _, runnerObj := range runnerObjs {
		...
		resp = append(resp, api.GcArtifactRunnerItem{
			ID:           runnerObj.ID,
			Status:       runnerObj.Status,
			Message:      string(runnerObj.Message),
			SuccessCount: runnerObj.SuccessCount,
...
//	@Failure	404				{object}	errcode.ErrCode
//	@Failure	500				{object}	errcode.ErrCode
func (h *handler) GetGcArtifactRunner(c *gin.Context, req *api.GetGcArtifactRunnerRequest) {
	ctx := c.Request.Context()

	runnerObj, err := h.DaemonSvc.GetGcArtifactRunner(ctx, req.NamespaceID, req.RunnerID)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("Get gc artifact runner failed: %v", err))
		return
	}
	var startedAt, endedAt *string
	if runnerObj.StartedAt != nil {
...
//	@Param		sort			query		string	false	"sort field"
//	@Param		method			query		string	false	"sort method"	Enums(asc, desc)
//	@Success	200				{object}	api.CommonList{items=[]api.GcArtifactRecordItem}
//	@Failure	400				{object}	errcode.ErrCode
//	@Failure	404				{object}	errcode.ErrCode
//	@Failure	500				{object}	errcode.ErrCode
func (h *handler) ListGcArtifactRecords(c *gin.Context, req *api.ListGcArtifactRecordsRequest) {
	ctx := c.Request.Context()

	recordObjs, total, err := h.DaemonSvc.ListGcArtifactRecords(ctx, req.RunnerID, req.Pagination, req.Sortable)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("List gc artifact records failed: %v", err))
		return
	}
...
//	@Failure	404				{object}	errcode.ErrCode
//	@Failure	500				{object}	errcode.ErrCode
func (h *handler) GetGcArtifactRecord(c *gin.Context, req *api.GetGcArtifactRecordRequest) {
	ctx := c.Request.Context()

	recordObj, err := h.DaemonSvc.GetGcArtifactRecord(ctx, req.NamespaceID, req.RunnerID, req.RecordID)
	if err != nil {
		if e, ok := errcode.AsType[errcode.ErrCode](err); ok {
			errcode.NewHTTPError(c, e)
			return
		}
		errcode.NewHTTPError(c, errcode.HTTPErrCodeInternalError, fmt.Sprintf("Get gc artifact record failed: %v", err))
		return
	}
