...
func TestFactory(t *testing.T) {
	...
	require.NoError(t, digCon.Invoke(func(engine *gin.Engine) {
		...
		require.True(t, hasRoute(routes, http.MethodGet, "/api/v1/namespaces/:namespace_id/repositories/"))
		require.True(t, hasRoute(routes, http.MethodPost, "/api/v1/namespaces/:namespace_id/repositories/"))
		require.True(t, hasRoute(routes, http.MethodDelete, "/api/v1/namespaces/:namespace_id/repositories/:repository_id"))
	}))
}
