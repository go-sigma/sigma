...
// 	assert.NoError(t, artifactHandler.ListArtifact(c))
...
// 	daoMockArtifactRepositoryTimes := 0
// 	daoMockArtifactRepository.EXPECT().ListArtifact(gomock.Any(), gomock.Any()).
// 		DoAndReturn(func(_ context.Context, _ api.ListArtifactRequest) ([]*models.Artifact, error) {
// 			daoMockArtifactRepositoryTimes++
// 			if daoMockArtifactRepositoryTimes == 1 {
// 				return nil, fmt.Errorf("test")
// 			}
// 			return []*models.Artifact{}, nil
// 		}).Times(3)
// 	daoMockArtifactRepository.EXPECT().CountArtifact(gomock.Any(), gomock.Any()).
// 		DoAndReturn(func(_ context.Context, _ api.ListArtifactRequest) (int64, error) {
