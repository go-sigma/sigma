            ...
            <div className="space-y-1">
              {
                menuList.map(m => {
                  return (
                    <Link to={`/${m.text.toLowerCase()}`} key={m.text} className={`text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md ${menuActive === m.text ? "bg-gray-100" : "hover:bg-gray-100 text-gray-700"}`} onClick={() => {
