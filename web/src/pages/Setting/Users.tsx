...
export default function ({ localServer }: { localServer: string }) {
  ...
  return (
    <Fragment>
      <HelmetProvider>
        <Helmet>
          <title>{t("header.settingUsers")}</title>
        </Helmet>
      </HelmetProvider>
                    ...
                    role === "User" ? (
                      <>
                        <label htmlFor="namespace_count_limit" className="text-sm font-medium text-gray-700 flex flex-row items-center">
                          ...
                          <div className="relative flex flex-row cursor-pointer group">
                            <div className="absolute left-1/2 top-0 z-20 hidden -translate-x-1/2 -translate-y-full whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white shadow-sm group-hover:block">
                              0 means no limit
                            </div>
