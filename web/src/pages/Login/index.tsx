    ...
    <>
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 dark:bg-gray-950 sm:px-6 lg:px-8">
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          ...
          <div className="bg-white px-6 py-12 shadow dark:bg-gray-900 sm:rounded-lg sm:px-12 mt-6">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    value={username}
                    required
                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:bg-gray-950 dark:text-gray-100 dark:ring-gray-700 sm:text-sm sm:leading-6"
                    onChange={(e) => {
                ...
                <div>
                  <div className="relative mt-10">
                    ...
                    <div className="relative flex justify-center text-sm font-medium leading-6">
                      <span className="bg-white px-6 text-gray-900 dark:bg-gray-900 dark:text-gray-100">{t("login.continueWith")}</span>
                    </div>
                  </div>
                  {
                    config.anonymous && (
