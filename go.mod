module github.com/ximager/ximager
...
require (
	...
	github.com/opencontainers/distribution-spec/specs-go v0.0.0-20230208164722-acfc11dad631
...
replace github.com/opencontainers/runc v1.1.0 => github.com/opencontainers/runc v1.0.0-rc90
