...
require (
	...
	github.com/distribution/distribution/v3 v3.0.0-20230816152046-6ccc551f9613
...
require (
	...
	github.com/aquasecurity/trivy-db v0.0.0-20230814142543-88b9998a942a // indirect
