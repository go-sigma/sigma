...
"$DOCKER" pull quay.io/minio/minio:RELEASE.2024-02-06T21-36-22Z
"$DOCKER" pull ghcr.io/go-sigma/sigma-builder:nightly
"$DOCKER" pull ghcr.io/go-sigma/sigma:nightly-alpine
"$DOCKER" pull redis:7.0-alpine
"$DOCKER" pull mysql:8.0

"$DOCKER" save quay.io/minio/minio:RELEASE.2024-02-06T21-36-22Z ghcr.io/go-sigma/sigma:nightly-alpine ghcr.io/go-sigma/sigma-builder:nightly redis:7.0-alpine mysql:8.0 | gzip > sigma.tar.gz
